...
// SendMessageResponse acknowledges receipt of a Raft message
type SendMessageResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Error         string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"` // Optional error message if success = false
...
const file_proto_transport_proto_rawDesc = "" +
	"\n" +
	"\x15proto/transport.proto\x12\x12rafteeze.transport\x1a\n" +
	"raft.proto\"E\n" +
	"\x13SendMessageResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error2X\n" +
	"\rRaftTransport\x12G\n" +
	"\vSendMessage\x12\x0f.raftpb.Message\x1a'.rafteeze.transport.SendMessageResponseB*Z(github.com/panuwatphakaew/rafteeze/protob\x06proto3"
...
var file_proto_transport_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_transport_proto_goTypes = []any{
	(*SendMessageResponse)(nil), // 0: rafteeze.transport.SendMessageResponse
	(*raftpb.Message)(nil),      // 1: raftpb.Message
}
var file_proto_transport_proto_depIdxs = []int32{
	1, // 0: rafteeze.transport.RaftTransport.SendMessage:input_type -> raftpb.Message
	0, // 1: rafteeze.transport.RaftTransport.SendMessage:output_type -> rafteeze.transport.SendMessageResponse
